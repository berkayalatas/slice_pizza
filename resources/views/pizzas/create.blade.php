...
<head>
    ...
    <style>
        ...
        body {
            background: linear-gradient(rgba(0, 0, 0, .1), rgba(255, 255, 255, .5)), url("https://images.unsplash.com/photo-1581873372796-635b67ca2008?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80") no-repeat center center fixed;
